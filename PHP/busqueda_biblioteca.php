...
*/
    switch($op){
        case "titulo":
            ...
            */
            $query = "select libro.isbn, libro.nombre_libro, group_concat(autor.nombre_autor) as nombre_autor,libro.editorial, libro.imagen 
			from ((libro
			inner join libro_autor on libro.isbn = libro_autor.isbn)
            inner join autor on autor.id_autor = libro_autor.num_autor)
            where libro.nombre_libro like '%$s%'
    ...
    ?>
     <form align='center' method='GET' action='consulta_prestamo.php'>
                    ...
                    echo"<div class='col-sm-6' style='padding-top:15px; padding-bottom:15px;'>";
                        echo"<div class='row'>";
                            ...
                            echo"<div class='col-md-8'>";
                                        ...
                                        echo'<div class="col-md-6" id="modificar"><a href="consulta_prestamo.php?isbn=' .$row['isbn'].'">Historial de prestamos</a></div>';
