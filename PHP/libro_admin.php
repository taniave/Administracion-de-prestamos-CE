...
<?php
    ...
    <table align='center'  width='50%'  cellpadding='5'>
        ...
        <tr align='left'><td style='padding-top: 10px; padding-bottom: 10px;'><b>Año de publicacion:</b> <input type='year' name='year' value='$row[3]' maxlength='4' id='year' class='libro' style='width:10%;'c readonly><br></td></tr>
        ...
        <tr>
				<td colspan='7'><a href='biblioteca_admin.php'><img src='../IMG/back.png'>Volver</a></td>
		</tr>
