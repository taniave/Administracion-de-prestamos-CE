...
*/
    switch($op){
        case "titulo":
            ...
            */
            $query = "select prestamo.num_prestamo, libro.nombre_libro, group_concat(autor.nombre_autor)as nombre_autor,libro.editorial,libro.imagen
			from (((((estudiante
			...
			inner join libro_autor on libro.isbn = libro_autor.isbn)
			inner join autor on autor.id_autor = libro_autor.num_autor)
            where libro.nombre_libro like '%$s%' and prestamo_libro.estado = 'En prestamo'
        ...
        case "autor":
            ...
            */
			...
			inner join libro_autor on libro.isbn = libro_autor.isbn)
			inner join autor on autor.id_autor = libro_autor.num_autor)
            where autor.nombre_autor like '%$s%' and prestamo_libro.estado = 'En prestamo'
            group by libro_autor.isbn"; // limit $startFrom,$showRecordPerPage";
